...
> 💡 **Screenshot-Platzhalter:** `docs/screenshots/env-variables-windows.png`
...
> 💡 **Screenshot-Platzhalter:** `docs/screenshots/prtg-apikey.png`
...
├──────────────┼──────────┼──────────────────────────────────┤
│ PRTG_API     │ ✓ OK     │ https://prtg.tal-oil.com         │
│ PRTG_APIV2   │ ✓ OK     │ https://prtg.tal-oil.com:1616    │
│ PRTG_APIKEY  │ ✓ OK     │ 7SLV****************************  │
│ PRTG_HASH    │ ✗ FEHLT  │ (nicht gesetzt)                  │
│ PRTG_PASSWORD│ ✗ FEHLT  │ (nicht gesetzt)                  │
│ PRTG_USER    │ ✓ OK     │ prtgadmin                        │
└──────────────┴──────────┴──────────────────────────────────┘
```
...
> 💡 **Screenshot-Platzhalter:** `docs/screenshots/config-anzeigen.png`
...
> 💡 **Screenshot-Platzhalter:** `docs/screenshots/test-auth.png`
...
> 💡 **Screenshot-Platzhalter:** `docs/screenshots/diagnose-prtg.png`
...
> 💡 **Screenshot-Platzhalter:** `docs/screenshots/sync-result.png`
...
> 💡 **Screenshot-Platzhalter:** `docs/screenshots/discovery-level-select.png`
...
> 💡 **Screenshot-Platzhalter:** `docs/screenshots/discovery-result.png`
